import{c as E}from"./footer-BQVaf_UP.js";function C(a){return E(a,{tag:"div",render(t,n,b,{runOnce:q}){const{options:p=[],defaultValue:r="",name:_="",placeholder:g="Не выбрано",disabled:d=!1}=n;t.className=`dropdown ${d?"dropdown_is-disabled":""}`,t.innerHTML=`
          <select 
