import{c as f,m as R,F as C,s as T,j as L,i as q,a as U}from"../../footer-BQVaf_UP.js";import{l as k}from"../../lazy-loading-Cecxv2lM.js";import{i as w}from"../../breadcrumbs-BpSfuU0S.js";import{a as F}from"../../accordion-FqG3kPc4.js";import{D as y}from"../../dropdown-Cjm1SIqw.js";import{c as A,r as M,s as g}from"../../index-B-aVQfpU.js";function j(o){return f(o,{tag:"div",render(t,d,l,{runOnce:n}){const{items:i=[],userId:r}=d;n&&(t.className="cart-table",t.innerHTML=`
          ...
          `,t._els={list:t.querySelector(".cart-table__list")}),I(t._els.list,i,r)}})}function I(o,t,d){o.innerHTML="",!(!t||!Array.isArray(t))&&t.forEach(l=>{const n=R({product:l,userId:d});o.appendChild(n)})}function O(o){return f(o,{tag:"div",render(t,d,l,{runOnce:n}){if(n){t.className="order-summary",t.innerHTML=`
  ...
  `}const D=async()=>{w(".cart-section__breadcrumbs");const o=document.querySelector(".cart-section__col-1"),t=document.querySelector(".cart-section__col-2"),l=(await T.auth.getUser())?.data?.user?.id||null,n=j({items:[],userId:l}),i=O();o.append(n),t.append(i),L.subscribe("cart",async r=>{const c=r.viewItems;console.log("cartpage: cartViewsItems",c),n.update({items:c})})};document.addEventListener("DOMContentLoaded",async()=>{q(),D(),U(),k(".lazy",{rootMargin:"200px 0px"})});
