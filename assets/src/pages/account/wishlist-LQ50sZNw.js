import{i as a,a as r,s as c,p as i,t as d,n as u}from"../../../footer-D3eUB4_-.js";import{i as l}from"../../../breadcrumbs-BpSfuU0S.js";import{i as b}from"../../../profile-section-BsnviRcq.js";import{a as m,c as _}from"../../../product-list-Cx4GFDPY.js";import"../../../dropdown-BAe8JTCa.js";document.addEventListener("DOMContentLoaded",async()=>{a(),l(".wishlist-page__breadcrumbs"),b(),r();const e=(await c.auth.getUser())?.data?.user?.id||null,t=await i.getWishlistProducts(e);document.querySelector(".profile-section__content").append(p(t,e))});function p(s,e){const t=document.createElement("div");t.className="wishlist",t.innerHTML=`
