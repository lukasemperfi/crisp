import{c as v}from"./footer-BQVaf_UP.js";const p=(e,t,s={})=>{const a=document.querySelector(e);if(!a){console.error(`Accordion: Container '${e}' not found`);return}const{isSingleOpen:d=!0}=s,o=document.createElement("div");o.className="accordion",o.innerHTML=t.map(n=>`
