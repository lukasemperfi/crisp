export const shippingTaxRules = {
  UA: {
    vinnytsia: { flatRate: 5.1, bestWay: 10.1 },
    volyn: { flatRate: 5.2, bestWay: 10.2 },
    dnipropetrovsk: { flatRate: 5.3, bestWay: 10.3 },
    donetsk: { flatRate: 5.4, bestWay: 10.4 },
    zhytomyr: { flatRate: 5.5, bestWay: 10.5 },
    zakarpattia: { flatRate: 5.6, bestWay: 10.6 },
    zaporizhzhia: { flatRate: 5.7, bestWay: 10.7 },
    "ivano-frankivsk": { flatRate: 5.8, bestWay: 10.8 },
    "kyiv-oblast": { flatRate: 5.0, bestWay: 10.0 },
    kirovohrad: { flatRate: 6.1, bestWay: 11.1 },
    luhansk: { flatRate: 6.2, bestWay: 11.2 },
    lviv: { flatRate: 7.0, bestWay: 12.0 },
    mykolaiv: { flatRate: 6.3, bestWay: 11.3 },
    odesa: { flatRate: 6.0, bestWay: 11.0 },
    poltava: { flatRate: 6.4, bestWay: 11.4 },
    rivne: { flatRate: 6.5, bestWay: 11.5 },
    sumy: { flatRate: 6.6, bestWay: 11.6 },
    ternopil: { flatRate: 6.7, bestWay: 11.7 },
    kharkiv: { flatRate: 6.8, bestWay: 11.8 },
    kherson: { flatRate: 6.9, bestWay: 11.9 },
    khmelnytskyi: { flatRate: 7.1, bestWay: 12.1 },
    cherkasy: { flatRate: 7.2, bestWay: 12.2 },
    chernivtsi: { flatRate: 7.3, bestWay: 12.3 },
    chernihiv: { flatRate: 7.4, bestWay: 12.4 },
  },
  BE: {
    antwerpen: { flatRate: 12.1, bestWay: 22.1 },
    limburg: { flatRate: 12.2, bestWay: 22.2 },
    "oost-vlaanderen": { flatRate: 12.3, bestWay: 22.3 },
    "vlaams-brabant": { flatRate: 12.4, bestWay: 22.4 },
    "west-vlaanderen": { flatRate: 12.5, bestWay: 22.5 },
    "waals-brabant": { flatRate: 12.6, bestWay: 22.6 },
    henegouwen: { flatRate: 12.7, bestWay: 22.7 },
    luik: { flatRate: 12.8, bestWay: 22.8 },
    luxemburg: { flatRate: 12.9, bestWay: 22.9 },
    namen: { flatRate: 13.0, bestWay: 23.0 },
  },
  CZ: {
    "hlavni-mesto-praha": { flatRate: 9.1, bestWay: 18.1 },
    "stredocesky-kraj": { flatRate: 9.2, bestWay: 18.2 },
    "jihocesky-kraj": { flatRate: 9.3, bestWay: 18.3 },
    "plzensky-kraj": { flatRate: 9.4, bestWay: 18.4 },
    "karlovarsky-kraj": { flatRate: 9.5, bestWay: 18.5 },
    "ustecky-kraj": { flatRate: 9.6, bestWay: 18.6 },
    "liberecky-kraj": { flatRate: 9.7, bestWay: 18.7 },
    "kralovehradecky-kraj": { flatRate: 9.8, bestWay: 18.8 },
    "pardubicky-kraj": { flatRate: 9.9, bestWay: 18.9 },
    vysocina: { flatRate: 10.1, bestWay: 19.1 },
    "jihomoravsky-kraj": { flatRate: 10.2, bestWay: 19.2 },
    "olomoucky-kraj": { flatRate: 10.3, bestWay: 19.3 },
    "zlinsky-kraj": { flatRate: 10.4, bestWay: 19.4 },
    "moravskoslezsky-kraj": { flatRate: 10.5, bestWay: 19.5 },
  },
  PL: {
    dolnoslaskie: { flatRate: 10.1, bestWay: 20.1 },
    "kujawsko-pomorskie": { flatRate: 10.2, bestWay: 20.2 },
    lubelskie: { flatRate: 10.3, bestWay: 20.3 },
    lubuskie: { flatRate: 10.4, bestWay: 20.4 },
    lodzkie: { flatRate: 10.5, bestWay: 20.5 },
    malopolskie: { flatRate: 12.0, bestWay: 22.0 },
    mazowieckie: { flatRate: 10.0, bestWay: 20.0 },
    opolskie: { flatRate: 10.6, bestWay: 20.6 },
    podkarpackie: { flatRate: 10.7, bestWay: 20.7 },
    podlaskie: { flatRate: 10.8, bestWay: 20.8 },
    pomorskie: { flatRate: 10.9, bestWay: 20.9 },
    slaskie: { flatRate: 11.1, bestWay: 21.1 },
    swietokrzyskie: { flatRate: 11.2, bestWay: 21.2 },
    "warminsko-mazurskie": { flatRate: 11.3, bestWay: 21.3 },
    wielkopolskie: { flatRate: 11.4, bestWay: 21.4 },
    zachodniopomorskie: { flatRate: 11.5, bestWay: 21.5 },
  },
  ES: {
    andalucia: { flatRate: 14.1, bestWay: 24.1 },
    aragon: { flatRate: 14.2, bestWay: 24.2 },
    asturias: { flatRate: 14.3, bestWay: 24.3 },
    baleares: { flatRate: 18.0, bestWay: 30.0 },
    canarias: { flatRate: 20.0, bestWay: 35.0 },
    cantabria: { flatRate: 14.4, bestWay: 24.4 },
    "castilla-la-mancha": { flatRate: 14.5, bestWay: 24.5 },
    "castilla-y-leon": { flatRate: 14.6, bestWay: 24.6 },
    catalunya: { flatRate: 14.7, bestWay: 24.7 },
    extremadura: { flatRate: 14.8, bestWay: 24.8 },
    galicia: { flatRate: 14.9, bestWay: 24.9 },
    madrid: { flatRate: 15.1, bestWay: 25.1 },
    murcia: { flatRate: 15.2, bestWay: 25.2 },
    navarra: { flatRate: 15.3, bestWay: 25.3 },
    "pais-vasco": { flatRate: 15.4, bestWay: 25.4 },
    "la-rioja": { flatRate: 15.5, bestWay: 25.5 },
    "ceuta-melilla": { flatRate: 21.0, bestWay: 36.0 },
  },
  IT: {
    abruzzo: { flatRate: 13.1, bestWay: 23.1 },
    basilicata: { flatRate: 13.2, bestWay: 23.2 },
    calabria: { flatRate: 13.3, bestWay: 23.3 },
    campania: { flatRate: 13.4, bestWay: 23.4 },
    "emilia-romagna": { flatRate: 13.5, bestWay: 23.5 },
    "friuli-venezia-giulia": { flatRate: 13.6, bestWay: 23.6 },
    lazio: { flatRate: 13.7, bestWay: 23.7 },
    liguria: { flatRate: 13.8, bestWay: 23.8 },
    lombardia: { flatRate: 13.9, bestWay: 23.9 },
    marche: { flatRate: 14.1, bestWay: 24.1 },
    molise: { flatRate: 14.2, bestWay: 24.2 },
    piemonte: { flatRate: 14.3, bestWay: 24.3 },
    puglia: { flatRate: 14.4, bestWay: 24.4 },
    sardegna: { flatRate: 16.0, bestWay: 28.0 },
    sicilia: { flatRate: 16.5, bestWay: 28.5 },
    toscana: { flatRate: 14.5, bestWay: 24.5 },
    "trentino-alto-adige": { flatRate: 14.6, bestWay: 24.6 },
    umbria: { flatRate: 14.7, bestWay: 24.7 },
    "valle-d-aosta": { flatRate: 14.8, bestWay: 24.8 },
    veneto: { flatRate: 14.9, bestWay: 24.9 },
  },
  DE: {
    "baden-wurttemberg": { flatRate: 11.1, bestWay: 21.1 },
    bayern: { flatRate: 15.0, bestWay: 25.0 },
    berlin: { flatRate: 13.0, bestWay: 23.0 },
    brandenburg: { flatRate: 11.2, bestWay: 21.2 },
    bremen: { flatRate: 11.3, bestWay: 21.3 },
    hamburg: { flatRate: 11.4, bestWay: 21.4 },
    hessen: { flatRate: 11.5, bestWay: 21.5 },
    "mecklenburg-vorpommern": { flatRate: 11.6, bestWay: 21.6 },
    niedersachsen: { flatRate: 11.7, bestWay: 21.7 },
    "nordrhein-westfalen": { flatRate: 11.8, bestWay: 21.8 },
    "rheinland-pfalz": { flatRate: 11.9, bestWay: 21.9 },
    saarland: { flatRate: 12.1, bestWay: 22.1 },
    sachsen: { flatRate: 12.2, bestWay: 22.2 },
    "sachsen-anhalt": { flatRate: 12.3, bestWay: 22.3 },
    "schleswig-holstein": { flatRate: 12.4, bestWay: 22.4 },
    thuringen: { flatRate: 12.5, bestWay: 22.5 },
  },
  NL: {
    drenthe: { flatRate: 10.1, bestWay: 19.1 },
    flevoland: { flatRate: 10.2, bestWay: 19.2 },
    friesland: { flatRate: 10.3, bestWay: 19.3 },
    gelderland: { flatRate: 10.4, bestWay: 19.4 },
    groningen: { flatRate: 10.5, bestWay: 19.5 },
    limburg: { flatRate: 10.6, bestWay: 19.6 },
    "noord-brabant": { flatRate: 10.7, bestWay: 19.7 },
    "noord-holland": { flatRate: 10.8, bestWay: 19.8 },
    overijssel: { flatRate: 10.9, bestWay: 19.9 },
    utrecht: { flatRate: 11.1, bestWay: 20.1 },
    zeeland: { flatRate: 11.2, bestWay: 20.2 },
    "zuid-holland": { flatRate: 11.3, bestWay: 20.3 },
  },
  PT: {
    aveiro: { flatRate: 12.1, bestWay: 22.1 },
    beja: { flatRate: 12.2, bestWay: 22.2 },
    braga: { flatRate: 12.3, bestWay: 22.3 },
    braganca: { flatRate: 12.4, bestWay: 22.4 },
    "castelo-branco": { flatRate: 12.5, bestWay: 22.5 },
    coimbra: { flatRate: 12.6, bestWay: 22.6 },
    faro: { flatRate: 12.7, bestWay: 22.7 },
  },
  SE: {
    blekinge: { flatRate: 15.1, bestWay: 28.1 },
    dalarnas: { flatRate: 15.2, bestWay: 28.2 },
    gotland: { flatRate: 15.3, bestWay: 28.3 },
    gavleborgs: { flatRate: 15.4, bestWay: 28.4 },
    halland: { flatRate: 15.5, bestWay: 28.5 },
    jamtland: { flatRate: 15.6, bestWay: 28.6 },
    jonkoping: { flatRate: 15.7, bestWay: 28.7 },
    kalmar: { flatRate: 15.8, bestWay: 28.8 },
    kronoberg: { flatRate: 15.9, bestWay: 28.9 },
    norrbotten: { flatRate: 16.1, bestWay: 29.1 },
    ostergotland: { flatRate: 16.2, bestWay: 29.2 },
    skane: { flatRate: 16.3, bestWay: 29.3 },
    sodermanland: { flatRate: 16.4, bestWay: 29.4 },
    stockholm: { flatRate: 16.5, bestWay: 29.5 },
    uppsala: { flatRate: 16.6, bestWay: 29.6 },
    varmland: { flatRate: 16.7, bestWay: 29.7 },
    vasternorrland: { flatRate: 16.8, bestWay: 29.8 },
    vastmanland: { flatRate: 16.9, bestWay: 29.9 },
    "vastra-gotaland": { flatRate: 17.1, bestWay: 30.1 },
    orebro: { flatRate: 17.2, bestWay: 30.2 },
  },
};
