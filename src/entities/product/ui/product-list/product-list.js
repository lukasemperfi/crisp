...
//     this._loader = document.createElement("div");
//     this._loader.className = "catalog__loader";
//     this._loader.textContent = "Loading..."; // Можно заменить на spinner
//     this._loader.style.display = "none";
//     this._btnWrapper.appendChild(this._loader);
//     // --- Конец изменений ---
...
//     this._btn.addEventListener("click", () => {
//       if (typeof this._onLoadMore === "function") {
//         this.showLoader(); // показываем лоадер при нажатии
//         this._onLoadMore().finally(() => {
//           this.hideLoader(); // скрываем лоадер после загрузки
//         });
//       }
//     });
...
//     if (this._loader) {
//       this._loader.style.display = "";
//       this._btn.style.display = "none"; // скрываем кнопку пока идет загрузка
//     }
//   }
...
//     if (this._loader) {
//       this._loader.style.display = "none";
//       this._btn.style.display = ""; // возвращаем кнопку после загрузки
//     }
//   }
//   // --- Конец изменений ---
// }
